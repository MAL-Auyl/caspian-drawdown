...
OBJECT_DEFS = [
    dict(object_id=1, name_ru="Водозаборный канал МАЭК",
         ...
         category="water_supply", criticality=10, lon=51.185, lat=43.638,
    ...
    dict(object_id=2, name_ru="Энергоблоки МАЭК",
         ...
         category="energy", criticality=9, lon=51.190, lat=43.645,
    ...
    dict(object_id=3, name_ru="Порт Актау",
         ...
         category="port", criticality=8, lon=51.152, lat=43.650,
    ...
    dict(object_id=4, name_ru="Порт Баутино",
         ...
         category="port", criticality=7, lon=50.305, lat=44.548,
    ...
    dict(object_id=5, name_ru="Набережная Актау",
         name_kk="Ақтау жағалауы", name_en="Aktau Waterfront",
         category="recreation", criticality=4, lon=51.235, lat=43.633,
         description_ru="Городская рекреационная зона вдоль моря.",
         description_kk="Теңіз жағалауындағы қалалық демалыс аймағы.",
         description_en="Urban recreational zone along the sea.",
         recommendation_ru="Учитывать отступление берега при благоустройстве.",
         recommendation_en="Account for shoreline retreat in landscaping plans."),
    dict(object_id=6, name_ru="Городской пляж",
         name_kk="Қалалық жағажай", name_en="City Beach",
         category="recreation", criticality=3, lon=51.240, lat=43.628,
    ...
    dict(object_id=7, name_ru="Rixos Water World Aktau",
         ...
         category="tourism", criticality=4, lon=51.203, lat=43.612,
    ...
    dict(object_id=8, name_ru="Прибрежная автодорога",
         ...
         category="transport", criticality=5, lon=51.198, lat=43.601,
